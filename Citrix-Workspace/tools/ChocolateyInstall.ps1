...
$installChocolateyPackageParams = @{
    ...
    Url            = "https://downloadplugins.citrix.com/ReceiverUpdates/Prod/Receiver/Win/CitrixWorkspaceApp24.5.12.42.exe";
    ValidExitCodes = @(0,3010,40008);
    Checksum       = "1a83cc4451438f98de598a43fd0c53615d3aaa75ce6be3d14ada05280e4396b8";
    ChecksumType   = "sha256";
}
