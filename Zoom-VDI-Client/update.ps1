...
function global:au_GetLatest {
    ...
    # Regex to find the VDI Client URL
    # Matches both standard = and HTML encoded &#61;
    # Looking for: https://zoom.us/download/vdi/{version}/ZoomInstallerVDI.msi?archType=x64
    $urlMatch = [regex]::match($content, 'https://zoom.us/download/vdi/([\d\.]+)/ZoomInstallerVDI\.msi\?archType(?:=|&#61;)x64')
    ...
    if ($urlMatch.Success) {
        ...
        throw "Could not find Zoom VDI Client download URL in the page."
    }
}
